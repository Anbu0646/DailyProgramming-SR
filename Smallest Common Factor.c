...
Boundary Condition(s): 2 <= N1, N2 <= 10^8 

Input Format:  The first line contains the values of N1 and N2 separated by space(s). 

Output Format: The first line contains the common factor. 
