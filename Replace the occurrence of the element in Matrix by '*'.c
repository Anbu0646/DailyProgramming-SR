...
The program must replace all the integers in the matrix which are present below the second occurrence of the integer K in each column by '*' and print the matrix as the output. 
